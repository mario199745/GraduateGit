...
--      m['coverpage-bg-image'] = script_path().."images/TheGreatWaveoffKanagawa.jpeg"
    ...
    demovals = {["title-align"] = "right", ["title-fontsize"] = 40, ["title-fontfamily"] = "times new roman.otf", ["title-bottom"] = "10in", ["author-style"] = "none", ["footer-fontsize"] = 20, ["footer-fontfamily"] = "times new roman.otf", ["footer-align"] = "right", ["footer-bottom"] = "9.5in", ["page-html-color"] = "F6D5A8", ["bg-image-fading"] = "north"}
...
--      m['coverpage-bg-image'] = script_path().."images/otter-bar.jpeg"
    ...
    demovals = {["title-color"] = "white", ["title-fontfamily"] = "times new roman.otf", ["title-fontsize"] = 100, ["author-fontstyle"] = {"textsc"}, ["author-sep"] = "newline", ["author-align"] = "right", ["author-fontsize"] = 30, ["author-bottom"] = "2in"}
    for dkey, val in pairs(demovals) do
      if isEmpty(m['coverpage-theme'][dkey]) then
        m['coverpage-theme'][dkey] = val
      end
